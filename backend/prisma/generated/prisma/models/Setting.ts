	...
	Prisma.PrismaPromise<
		Array<
			Prisma.PickEnumerable<SettingGroupByOutputType, T['by']> & {
				[P in keyof T &
					keyof SettingGroupByOutputType]: P extends '_count'
					? T[P] extends boolean
						? number
						: Prisma.GetScalarType<
								T[P],
								SettingGroupByOutputType[P]
							>
...
export type SettingWhereUniqueInput = Prisma.AtLeast<
	{
		...
		updated_at?: Prisma.DateTimeFilter<'Setting'> | Date | string
		deleted_at?:
			| Prisma.DateTimeNullableFilter<'Setting'>
			| Date
			| string
			| null
	},
...
export type SettingScalarWhereWithAggregatesInput = {
	...
	deleted_at?:
		| Prisma.DateTimeNullableWithAggregatesFilter<'Setting'>
		| Date
		| string
		| null
}
